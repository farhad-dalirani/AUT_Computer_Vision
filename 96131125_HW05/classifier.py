...
if __name__ == '__main__':
    ...
    for image in images_train:
        feature = keypoints_to_features(image=image, kmeans_bow=bowDiction, dictionary_size=100, feature_detector_name='sift')
    ...
    for image in images_test:
        feature = keypoints_to_features(image=image, kmeans_bow=bowDiction, dictionary_size=100,
