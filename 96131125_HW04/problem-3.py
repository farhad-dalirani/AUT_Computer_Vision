...
if __name__ == '__main__':
    ...
    # sift key point for template
    temp_kp, temp_desc = sift.detectAndCompute(template_big, None)
    ...
    for x, y, sub_img in sliding_window(image=image, stepSize=template_shape[1]//4, windowSize=(template_shape[0]+5, template_shape[1]+5)):
        ...
        # sift descriptor for sliding window
        slide_kp, slide_desc = sift.detectAndCompute(sub_img, None)
    ...
    cv.imwrite('.\\3\\1.jpg', image_copy_rec)
    cv.imwrite('.\\3\\2.jpg', image_copy_point)
    cv.waitKey(0)
