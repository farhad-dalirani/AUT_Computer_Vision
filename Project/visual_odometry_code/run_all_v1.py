...
import cv2 as cv
import os
from monocular_visual_odometry_v1 import do_visual_odometry, MonocularVisualOdometry
...
# for all sequence do monocular visual odometry (sequence '00', '01', '02', ..., '10'
for seq in [str(i).zfill(2) for i in range(0,11)]:
    ...
    # do visual odometry
    do_visual_odometry(monocular_visual_odometry=monocular_visual_odometry, path_images=path_images,
